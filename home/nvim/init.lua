...
setup_filetype('json', 2)
setup_filetype('yaml', 2)
...
require('lualine').setup {
    sections = {
		lualine_c = {
			--'lsp_progress' -- now noice-nvim shows the diagnostics
		}
	}
}
...
-- noice
require("noice").setup({
	-- place every interactive popup a little bit abouve the center
	views = {
		cmdline_popup = {
			position = {
				row = "40%",
